...
public class Ofmucmember extends OfmucmemberKey {
    ...
    public String getJoinroomdate() {
        return joinroomdate;
    }

    public void setJoinroomdate(String joinroomdate) {
        this.joinroomdate = joinroomdate == null ? null : joinroomdate.trim();
    }

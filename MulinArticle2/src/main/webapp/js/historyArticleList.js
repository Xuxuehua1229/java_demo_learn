		...
		success : function(x) {	
			...
			if(!dataLen){
				...
				for(var i=0;i<data.length;i++){
					...
					var edit = "<td><a class='editBtn' href='#/editArticle?type=2&editArticleId="+activityID+"&muactivityID="+muactivityID+"'>编辑</a></td>";
					var subjectName = "";
					var subsubjectName = "";
					if(subjectID){
						...
						title = "<td class='art_title_td'><a class='art_title' href='http://365linju.com/articleContent.html?type=2&articleId=" +
								activityID+"&muactivityID="+muactivityID+"&subject="+subjectName+"' target='_blank'>" + articleTitle + "</a></td>";
						edit = "<td><a class='editBtn' href='#/editArticle?type=2&editArticleId="+activityID+"&muactivityID=" + muactivityID +
							   "&subject=" + subjectName+"'>编辑</a></td>";
					};	
					if(isArt){
						title = "<td class='art_title_td'><a class='art_title' href='http://365linju.com/articleContent.html?type=2&articleId=" +
					...
					if(actType == 6){
						edit = "<td><a class='editBtn' href='#/editArticle?type=2&editArticleId="+activityID+"&muactivityID=" + muactivityID +"&zongJieActivityID="+
...
$(function(){
	...
	//获取房间列表
	getRoomList('historyArticleList');
	//查询文章并在页面显示列表
	getReleaseArticleList();	

		...
		success : function(x) {			
			...
			if(!dataLen){
				...
				for(var i=0;i<data.length;i++){
					...
					var $tr = $("<tr>");
					var title = "<td class='art_title_td'><a class='art_title' href='http://365linju.com/articleContent.html?type=1&articleId=" + 
								activityID + "' target='_blank'>"+articleTitle+"</a></td>";
					var edit = "<td><a class='editBtn' href='#/editArticle?type=1&familyactivity=1&editArticleId="+activityID+"'>编辑</a></td>";
